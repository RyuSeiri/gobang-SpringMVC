...
<script type='text/javascript' src='${pageContext.request.contextPath}/js/gobangPvp.js'></script>
<%-- <script src='${pageContext.request.contextPath}/js/gobangPlay.js'></script> --%>
</head>
